                ...
                var calendar = new FullCalendar.Calendar(calendarEl, {
                    ...
                    dayCellDidMount: function(info) {
                        ...
                        if (dateInfo[dateStr] && dateInfo[dateStr].has_schedule) {
                            // Ubah background langsung
                            info.el.style.backgroundColor = '#e0f7fa'; // warna yang kamu mau

                            // (opsional) tambahkan titik indikator seperti sebelumnya
                            ...
                            // Pastikan posisi relative agar dotContainer bisa diatur
                            info.el.style.position = 'relative';
                            info.el.appendChild(dotContainer);
                        }
                    },
                    dateClick: function(info) {
                        console.log("As Date:", info.date);
                        ...
                        console.log("Tanggal Lokal:", dateStr);
                        console.log(dateInfo[dateStr], dateInfo)

                        if (dateInfo[dateStr] && dateInfo[dateStr].has_schedule) {
                            window.location.href = '{{ url('admin/checklist-schedule/by-date') }}/' +
                                dateStr;
                        }
                    }
                });
...
<x-dashboard-layout>
    <x-dashboard.button href="{{ route('admin.checklist-schedule.create') }}" class="mb-4">
