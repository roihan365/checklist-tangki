        ...
        <x-dashboard.card>
            <x-dashboard.card.header>
                <div class="flex items-center justify-between">
                    <div>
                        <h2 class="text-xl font-semibold text-gray-800 dark:text-white">Manajemen Dokumen</h2>
                        <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Kelola dokumen kendaraan tangki bahan bakar
                            Pertamina</p>
                    </div>
                </div>
            </x-dashboard.card.header>
            ...
            <x-dashboard.card.content>
                <!-- Filter Form -->
                <form method="GET" action="{{ route('distributor.tank-trucks.index') }}" class="mb-6">
                                ...
                                <tr class="hover:bg-gray-50 dark:hover:bg-gray-700">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                        <div class="flex justify-end space-x-2">
                                            <x-dashboard.button href="{{ route('distributor.document.show', $truck) }}"
