    ...
    <div class="py-6">
        <x-dashboard.card>
            <x-dashboard.card.header>
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex space-x-2">
                        <x-dashboard.button href="{{ route('distributor.tank-trucks.show', $tankTruck) }}" variant="secondary">
            ...
            <x-dashboard.card.content>
                <form method="POST" action="{{ route('distributor.tank-trucks.store-document', $tankTruck) }}"
