            ...
            <x-dashboard.card.header>
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex space-x-2">
                        <x-dashboard.button href="{{ route('distributor.tank-trucks.create') }}" variant="default">
                                ...
                                <tr class="hover:bg-gray-50 dark:hover:bg-gray-700">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                        <div class="flex justify-end space-x-2">
                                            <x-dashboard.button href="{{ route('distributor.tank-trucks.edit', $truck) }}"
                                                variant="secondary" size="sm">
                                                Edit
                                            </x-dashboard.button>
                                            <form action="{{ route('distributor.tank-trucks.destroy', $truck) }}" method="POST"
