...
class TankTruckController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('pages.distributor.tank-truck.index', compact('tankTrucks', 'distributors', 'statuses'));
    }
    ...
    public function create()
    {
        ...
        return view('pages.distributor.tank-truck.create', compact('distributors', 'statuses'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('distributor.tank-trucks.index')
    ...
    public function edit(TankTruck $tankTruck)
    {
        ...
        return view('pages.distributor.tank-truck.create', compact('tankTruck', 'distributors', 'statuses'));
    }
    ...
    {
        return view('pages.distributor.document.document', compact('tankTruck'));
    }
    ...
    public function storeDocument(Request $request, TankTruck $tankTruck)
    {
        ...
        TankTruckHistory::create([
            ...
            'deskripsi' => 'Truk ' . $document->tankTruck->plat_nomor . ' Dokumen ' . $document->jenis_dokumen . ' ' . 'berhasil diupload',
            'user_id' => Auth::id(),
            'metadata' => [
        ...
        return redirect()->route('distributor.tank-trucks.show', $tankTruck)
